...
# prepare build dir
WORKDIR /app
# workaround for bug i multiplattform build? https://elixirforum.com/t/multi-platform-docker-image-build-fails/66916/3
# trengs bare når man bygger på arm?
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/anda ./
COPY entrypoint.sh .
USER nobody
